...
2. **Configure Dynamic DNS** — See [Set Up Dynamic DNS]({{ site.baseurl }}/getting-started/example-setup-dynamic-dns/)
3. **Add VPN Clients** — See [Add VPN Clients]({{ site.baseurl }}/getting-started/example-add-vpn-clients/)
4. **Test SSH Access** — See [Configure SSH Access]({{ site.baseurl }}/getting-started/example-configure-ssh/)
...
**Can't SSH in?**
See [Configure SSH Access]({{ site.baseurl }}/getting-started/example-configure-ssh/)

## Related

- Full guide: [Getting Started]({{ site.baseurl }}/getting-started/)
- Detailed setup: [Manual Setup Guide]({{ site.baseurl }}/getting-started/setup/)
- Architecture: [How It Works]({{ site.baseurl }}/guides/architecture/)
